...
export function ScreenshotButton({
   ...
   const handleTakeScreenshot = useCallback(async () => {
      ...
      console.log(base64image) //imagem da página
      ...
      return (
         <button
            ...
            style={{
               ...
               backgroundPosition: 'right bottom', //atributo para exibir o canto inferior esquerdo, pois o só tem o widget na página (DESNECESSÀRIO)
               backgroundSize: 180, //atributo para exibir o canto inferior esquerdo, pois o só tem o widget na página (DESNECESSÀRIO)
            }}
